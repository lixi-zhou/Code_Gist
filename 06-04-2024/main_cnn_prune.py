...
with tf.device('/cpu:0'):
    ...
    for m1_name, m2_name in tqdm(model_dedup_comb):
        ...
        m1 = prune_model(m1, x_train, y_train)
        m2 = prune_model(m2, x_train, y_train)
    ...
    ori_dedup_result_df.to_csv('prune_new_model_modify_dedup_' + str(fp) + '_' + str(block_size) + '_' +  str(weight_lower_bound) + '_mb.csv', index=False)
